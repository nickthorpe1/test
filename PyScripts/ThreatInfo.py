...
EXCEL_FILE = 'threat_actor_info.xlsx'
...
def save_to_excel(data, actor_name):
    ...
    try:
        ...
        if actor_name in book.sheetnames:
            ...
            new_data = df[pd.to_datetime(df['last_updated']) > last_updated_existing]
            ...
            with pd.ExcelWriter(EXCEL_FILE, engine='openpyxl', mode='a') as writer:
                df.to_excel(writer, sheet_name=actor_name, index=False, header=True)
